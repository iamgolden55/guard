...
setVersion("@fluentui/react", "8.123.0");
  ...
  var Async2 = (
    ...
    function(_super) {
      ...
      Async3.prototype.render = function() {
        ...
        var Component7 = this.state.Component;
        return Component7 ? React3.createElement(Component7, __assign(__assign({}, rest), { ref: forwardedRef })) : Placeholder ? React3.createElement(Placeholder, null) : null;
      };
...
function classNamesFunction(options) {
  ...
  var getClassNames3 = function(styleFunctionOrObject, styleProps) {
    var _a3;
...
setVersion("@fluentui/react-window-provider", "2.2.29");
...
function styled(Component7, baseStyles, getProps, customizable2, pure) {
  ...
  var Wrapped = React20.forwardRef(function(props, forwardedRef) {
    ...
    return React20.createElement(Component7, __assign({ ref: forwardedRef }, rest, additionalProps, props, { styles: styles.current }));
  });
  Wrapped.displayName = "Styled".concat(Component7.displayName || Component7.name);
...
setVersion("@fluentui/utilities", "8.15.20");
...
function useTarget(target, hostElement) {
  var _a3, _b, _c;
  var previousTargetProp = React38.useRef();
...
function useLoadState(props, imageElement) {
  ...
  var _a3 = React41.useState(ImageLoadState.notLoaded), loadState = _a3[0], setLoadState = _a3[1];
  useIsomorphicLayoutEffect(function() {
...
var ImageBase = React41.forwardRef(function(props, forwardedRef) {
  ...
  var _a3 = useLoadState(props, imageElement), loadState = _a3[0], onImageLoaded = _a3[1], onImageError = _a3[2];
...
setVersion("@fluentui/theme", "2.6.65");
...
var FLUENT_CDN_BASE_URL = "https://res.cdn.office.net/files/fabric-cdn-prod_20250310.001";

// node_modules/@fluentui/style-utilities/lib/version.js
setVersion("@fluentui/style-utilities", "8.12.0");
...
var getIconContent = memoizeFunction(
  function(iconName) {
    var _a3 = getIcon(iconName) || {
      subset: {},
      code: void 0
    }, code = _a3.code, subset = _a3.subset;
    if (!code) {
      return null;
    }
    return {
...
var FontIcon = function(props) {
  var iconName = props.iconName, className = props.className, _a3 = props.style, style = _a3 === void 0 ? {} : _a3;
...
var IconBase = (
  ...
  function(_super) {
    ...
    IconBase2.prototype.render = function() {
      var _a3 = this.props, children = _a3.children, className = _a3.className, styles = _a3.styles, iconName = _a3.iconName, imageErrorAs = _a3.imageErrorAs, theme = _a3.theme;
...
//# sourceMappingURL=chunk-HG7HC7C7.js.map
