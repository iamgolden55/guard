...
import { Clock16Regular, Location16Regular, Person16Regular } from '@fluentui/react-icons';
...
export const EventDetails: React.FC<EventDetailsProps> = ({
  ...
  return (
    <div className="bg-white rounded-lg border border-gray-200 overflow-hidden">
      <div className={`h-1 ${accentColorClass}`} />
      ...
      <div className="p-4">
        ...
        <div className="flex items-center gap-2 text-sm text-gray-600 mb-2">
          <Clock16Regular className="w-4 h-4" />
          <span>
        ...
        <div className="text-sm text-gray-600 ml-6 mb-4">
          {formatTime(startTime)} - {formatTime(endTime)}
        </div>

        {event.shift?.venueName && (
          <div className="flex items-center gap-2 text-sm text-gray-600 mb-4">
            <Location16Regular className="w-4 h-4" />
