...
/** Payroll lifecycle:
 *   pending  → manager hasn't reviewed the hours yet
 *   approved → reviewed & locked, ready for export to Xero / payment
...
export interface Officer {
  ...
  sia: Sia;
  rejectReason?: string;
  /** Invoice identifier returned by the billing facade — used for export/PDF calls. */
  invoiceId?: string;
}
...
export interface InvoiceLineItem {
  ...
  rate: number | null;
  amount: number;
  /** Shift FK — used by the AdjustHoursModal to target the right shift. */
  shiftId?: number | null;
  /** ISO timestamp of the shift's recorded check-in. Prefilled into the
   * AdjustHoursModal so managers correct an existing time instead of
   * retyping it from scratch. Null when the shift has no recorded time. */
...
export type PayrollCycle = "weekly" | "monthly";
  ...
  1: {
    items: [
      ...
      },
      {
        ...
        date: "Fri 25 Apr",
        venue: "Southbank Arena",
        detail: "22:00 → 02:00 · OT tier 1 (1.5×)",
        hrs: 4.0,
        rate: 26.25,
        amount: 105.0,
      },
  ...
  3: {
    items: [
      ...
      },
      {
        ...
        date: "Fri 25 Apr",
        venue: "Victoria Park",
        detail: "Bank holiday — single-day rate",
        hrs: null,
        rate: null,
        amount: 128.0,
      },
      {
        ...
        date: "Sat 26 Apr",
        venue: "Victoria Park",
        detail: "Special event · festival main stage",
        hrs: 8.0,
        rate: 20.0,
        amount: 80.0,
      },
  ...
  4: {
    items: [
      ...
      },
      {
        ...
        date: "Wed 23 Apr",
        venue: "Canary Wharf",
        detail: "15:00 → 21:00 · OT tier 1 (1.5×)",
        hrs: 6.0,
        rate: 36.0,
        amount: 216.0,
      },
      {
        ...
        date: "Thu 24 Apr",
        venue: "Canary Wharf",
        detail: "05:00 → 11:00 · OT tier 2 (2×) · beyond 58h cap",
        hrs: 6.0,
        rate: 48.0,
        amount: 288.0,
      },
    ...
    adjustments: [
      {
        ...
        before: "07:00 → 19:00",
        after: "07:00 → 21:00",
        delta: "+2.00h · moved to OT1",
        by: "Alex Mead (Director)",
        on: "Wed 23 Apr 21:12",
      },
      {
        date: "Thu 24 Apr",
...
export const RUN_HISTORY: PayrollHistoryRun[] = [
  {
    id: "W16-2026",
    label: "w/c 13 Apr 2026",
    cycle: "weekly",
    gross: 82780.15,
    status: "paid",
    exported: "Xero · 24 Apr",
  },
  {
    id: "W15-2026",
    label: "w/c 06 Apr 2026",
    cycle: "weekly",
    gross: 79410.0,
    status: "paid",
    exported: "Xero · 17 Apr",
  },
  {
    id: "W14-2026",
    label: "w/c 30 Mar 2026",
    cycle: "weekly",
    gross: 88250.75,
    status: "paid",
    exported: "Xero · 10 Apr",
  },
  {
    id: "W13-2026",
    label: "w/c 23 Mar 2026",
    cycle: "weekly",
    gross: 81920.4,
    status: "paid",
    exported: "Xero · 03 Apr",
  },
];
...
export function siaTone(
  sia: Sia,
): { tone: PillTone; label: string; tip: string } | null {
  if (sia.expired)
    return {
      tone: "danger",
      label: "SIA expired",
      tip: `${Math.abs(sia.expiresInDays)}d ago`,
    };
  if (sia.expiresInDays <= 30)
    return {
      tone: "warning",
      label: "SIA expiring",
      tip: `${sia.expiresInDays}d`,
    };
  return null;
}
