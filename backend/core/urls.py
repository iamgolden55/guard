...
urlpatterns = [
    ...
    # Liveness for Render (never touches Postgres/Redis); readiness for an uptime monitor.
    path('api/v1/health/', health.liveness, name='health-check'),
    path('api/v1/health/ready/', health.readiness, name='health-ready'),
]
