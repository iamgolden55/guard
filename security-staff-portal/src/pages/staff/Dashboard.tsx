    ...
    <MainLayout>
      ...
      {!showMandatoryForm && !showResubmit && (
        <Stack tokens={{ childrenGap: 20 }}>
          {needsApproval && (
            <Stack tokens={{ childrenGap: 8 }} style={{ background: '#fffbe6', border: '1px solid #ffe58f', borderRadius: 8, padding: 16 }}>
              <Text variant="large" style={{ color: '#ad8b00' }}>
                Your profile is under review. You will be notified when approved.
              </Text>
              <Text>If you need to update your details, you can resubmit your profile below.</Text>
              <PrimaryButton text="Resubmit Profile" onClick={() => setShowResubmit(true)} />
            </Stack>
          )}
          {/* Welcome section */}
